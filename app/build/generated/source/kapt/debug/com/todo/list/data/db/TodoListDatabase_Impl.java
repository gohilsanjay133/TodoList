...
import com.todo.list.data.db.dao.TodoListDAO_Impl;
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `TodoList` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `name` TEXT NOT NULL, `completionStatus` INTEGER NOT NULL, `completionDeadline` INTEGER NOT NULL)");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '104b147ad70d6f63afe372f0f2caa5a8')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        _columnsTodoList.put("name", new TableInfo.Column("name", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsTodoList.put("completionStatus", new TableInfo.Column("completionStatus", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsTodoList.put("completionDeadline", new TableInfo.Column("completionDeadline", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (! _infoTodoList.equals(_existingTodoList)) {
          return new RoomOpenHelper.ValidationResult(false, "TodoList(com.todo.list.data.db.model.TodoListData).\n"
                  + " Expected:\n" + _infoTodoList + "\n"
                  + " Found:\n" + _existingTodoList);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "104b147ad70d6f63afe372f0f2caa5a8", "2be5472386bc2d3a97e2bc0c2ce1f010");
